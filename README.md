...
| Phase | Strategy | Verified Efficiency | Key Discovery |
| :--- | :--- | :--- | :--- |
...
| **IV: Synergy** | `cumulative_v30k`| **0.6135 ± 0.009** | Integrated geometry & ratio gating. |
